...
const widgetParams = JSON.parse((args.widgetParameter != null) ? args.widgetParameter : '{ "LAT" : "37.604" , "LON" : "127.156" , "LOC_NAME" : "우리집 근처" }')
...
const API_KEY = "58b2e13c87824410e92646ac626dae24"
...
// Support locales
const locale = "ko" // "fr" "it" "de" etc. for weather description language
const nowstring = "현재" // Your local term for "now"
const feelsstring = "체감" //Your local term for "feels like"
const relHumidity = "습도" // any local term for "humidity"
const pressure = ""
const windspeed = ""
...
const accentColor = new Color("#FF8400", 1)
// backgroundColor : Color > Background color of the widgets.
const backgroundColor = new Color("#222831", 1)
...
const weatherDescriptionCoords = new Point(30, 56)
// weatherDescriptionFontSize : number > Font size of the weather description label.
const weatherDescriptionFontSize = 16
...
const feelsLikeCoords = new Point(32, 230)
...
let todayLabel = weekArray[today];

drawText(strDate + ' ' + todayLabel + ' ' + LOCATION_NAME, locationNameFontSize, locationNameCoords.x, locationNameCoords.y, accentColor);
